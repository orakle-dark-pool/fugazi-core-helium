...
export interface FakeUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface FakeUSD extends BaseContract {
  connect(runner?: ContractRunner | null): FakeUSD;
  waitForDeployment(): Promise<this>;

  interface: FakeUSDInterface;
