...
export interface FakeFGZInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface FakeFGZ extends BaseContract {
  connect(runner?: ContractRunner | null): FakeFGZ;
  waitForDeployment(): Promise<this>;

  interface: FakeFGZInterface;
