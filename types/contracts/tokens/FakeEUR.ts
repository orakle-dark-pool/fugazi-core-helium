...
export interface FakeEURInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface FakeEUR extends BaseContract {
  connect(runner?: ContractRunner | null): FakeEUR;
  waitForDeployment(): Promise<this>;

  interface: FakeEURInterface;
